...
const checks = [
  ...
  ["fiche centre mise en avant", "src/app/(public)/[orgSlug]/page.tsx", "Des formateurs du terrain"],
  ["fiche centre formations", "src/app/(public)/[orgSlug]/page.tsx", "Des programmes pensés pour l&apos;emploi"],
