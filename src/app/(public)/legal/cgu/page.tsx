  ...
  return (
    <main className="public-page">
      ...
      <article className="legal-page">
        ...
        <p>L&apos;utilisateur reste responsable des données saisies, des décisions prises et du respect de ses obligations réglementaires (Qualiopi, RGPD, obligations déclaratives Datadock…). La responsabilité directe de Le Bon Rebond est limitée au montant des sommes versées au cours des 12 derniers mois.</p>
        ...
        <p style={{ marginTop: 40, padding: "16px 20px", background: "#f3f4f6", borderRadius: 10, fontSize: 14 }}>
          Contact : <a href="mailto:legal@lebonrebond.fr">legal@lebonrebond.fr</a>
        </p>
      </article>
    </main>
  );
