...
export default async function AdminCentresPage() {
  ...
  return (
    <div className="fade-up">
      ...
      <Card>
        <table className="tbl">
          <thead><tr><th>Centre</th><th>Ville</th><th>Plan</th><th>Statut facturation</th><th>Profil public</th><th>Formateurs</th><th>Formations</th><th>Sessions</th><th>Bénéf.</th><th></th></tr></thead>
          <tbody>
            {centers.map((o) => (
              <tr key={o.id}>
                ...
                <td>{o.publicProfileEnabled ? <span className="badge badge-positive">Publié</span> : <span className="badge badge-neutral">Privé</span>}</td>
