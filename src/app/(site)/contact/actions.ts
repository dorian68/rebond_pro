    ...
    await sendEmail({
      ...
      html: brandedEmail(
        ...
        `<table style="width:100%;border-collapse:collapse;font-size:14px">
          ...
          <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#888">CPF</td><td style="padding:8px 0;border-bottom:1px solid #eee">${d.cpfCheck ? "✅ Souhaite vérifier son éligibilité CPF" : "Non mentionné"}</td></tr>
