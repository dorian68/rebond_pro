...
export type UIBlock =
  ...
  | { type: "connector_oauth_card"; id?: string; connector: string; scope: "personal" | "organization"; label: string; title: string; description?: string; policy: "READ_ONLY" | "DRAFT_ONLY" | "SEND"; canConnect: boolean; blockedReason?: string }
